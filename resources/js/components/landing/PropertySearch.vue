...
const listingValue = computed({
    ...
    set: (val: string) => { selectedListings.value = val ? [val] : []; },
});
...
<template>
    <section ref="sectionRef" class="relative overflow-hidden px-6 py-28">
        ...
        <div class="absolute inset-0">
            <img src="/images/landing/search-bg.jpg" alt="" class="absolute inset-0 h-full w-full object-cover" />
            <video
                v-if="isMounted"
            ...
            >
                ...
                <div class="flex flex-col items-end gap-4 md:flex-row">
                    <div class="w-full shrink-0 md:w-auto">
                        <label class="mb-1 block font-body text-2xs font-medium tracking-wider text-white/40 uppercase">Buy / Rent</label>
                        <ToggleGroup
                            type="single"
                    ...
                    <div class="min-w-0 flex-1">
                        <MultiSelectFilter v-model="selectedTypes" label="Property Type" :options="propertyTypes" placeholder="All Types" />
                    </div>

                    <div class="min-w-0 flex-1">
                        <MultiSelectFilter v-model="selectedCities" label="Location" :options="cities" placeholder="All Cities" />
                    </div>
                </div>
                ...
                <div class="flex flex-col items-end gap-4 md:flex-row">
                    ...
                    <div class="w-full shrink-0 md:w-36">
                        <label class="mb-1 block font-body text-2xs font-medium tracking-wider text-white/40 uppercase">
