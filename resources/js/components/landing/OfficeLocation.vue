 ...
 */
const LeafletMap = defineAsyncComponent(() => import('@/components/landing/LeafletMap.vue'));
...
<template>
    <section ref="sectionRef" class="bg-linear-to-b from-landing-charcoal to-landing-deep-teal px-6 py-28 text-white">
        <div class="mx-auto max-w-6xl">
            ...
            >
                <!-- Contact info -->
                <div class="flex flex-col justify-center space-y-8 lg:col-span-2">
                    <div>
                        <h3 class="font-serif text-xl font-semibold">
                            {{ office.name }}
                        </h3>
                        <p class="mt-2 font-body text-sm leading-relaxed text-white/60">
                            {{ office.address }}<br />
                            {{ office.city }}
                        </p>
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        >
                            <span class="flex size-8 items-center justify-center rounded-full border border-white/10">
                    ...
                    <div class="border-t border-white/10 pt-6">
                        <p class="font-body text-xs uppercase tracking-widest text-white/40">
                            Office Hours
                        </p>
                ...
                <div class="relative overflow-hidden rounded-xl lg:col-span-3">
                    <div class="aspect-[4/3] w-full lg:aspect-auto lg:h-[420px]">
                        <Suspense>
                            <LeafletMap
                            ...
                            />
                            <template #fallback>
                                <div class="flex h-full w-full items-center justify-center bg-landing-charcoal/50">
                                    <div class="text-center">
                                        <div class="mx-auto mb-3 size-8 animate-spin rounded-full border-2 border-landing-gold border-t-transparent" />
                                        <p class="font-body text-sm text-white/40">Loading map...</p>
                                    </div>
                                </div>
                            </template>
                        </Suspense>
