...
<template>
    <div
        class="mb-10 grid grid-cols-3 gap-4 rounded-xl border border-white/10 bg-white/5 p-4 sm:grid-cols-6"
    >
        <div class="flex flex-col items-center gap-1">
            ...
            <span
                class="font-body text-2xs tracking-wider text-white/40 uppercase"
                >Bedrooms</span
            >
        </div>
        <div class="flex flex-col items-center gap-1">
        ...
        <div v-if="yearBuilt" class="flex flex-col items-center gap-1">
        ...
        <div v-if="lotSizeSqft" class="flex flex-col items-center gap-1">
